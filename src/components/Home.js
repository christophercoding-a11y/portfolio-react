            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <h3 className="h3-heading">Coding Languages & Frameworks that I've learned</h3>
                    ...
                    <div className="col-md-6">
                        <figure className="headshot-figure">
                            <img src="images/me.jpeg"alt="Christopher Jackson smiling" className="img-fluid image figure-image" />
